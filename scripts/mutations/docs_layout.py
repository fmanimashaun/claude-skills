...
GUARD = Guard(
    ...
    mutations=(
        ...
        Mutation(
            "a canvas's imported module is refused as code in docs/, though the canvas beside it cannot load it from anywhere else",
            '        if p.suffix.lower() in CANVAS_MODULE_EXT and imported_by_sibling_canvas(p):\n            return "authored"',
            '        if False:\n            return "authored"',
            "a module a sibling canvas imports is the design",
        ),
        Mutation(
