...
ENTRIES: tuple[Entry, ...] = (
    ...
    E("Landing page archetype", ARCHETYPE, "needs doctrine #90", "—", ["marketing/page-examples/landing-pages"], []),
    E("Pricing page archetype", ARCHETYPE, "needs doctrine #90", "—", ["marketing/page-examples/pricing-pages"], []),
    E("About page archetype", ARCHETYPE, "needs doctrine #90", "—", ["marketing/page-examples/about-pages"], []),
    E("Error page archetype (404/500)", ARCHETYPE, "needs doctrine #90", "—", ["marketing/feedback/404-pages"], [],
      "an intentional error-page DESIGN — it returns 200 and is a legitimate page under test (qa-flow #106)"),
    E("Auth page archetype (sign-in / sign-up / reset)", ARCHETYPE, "needs doctrine #90", "—",
    ...
    E("Storefront page archetype", ARCHETYPE, "needs doctrine #91", "—", ["ecommerce/page-examples/storefront-pages"], []),
    E("Category page archetype", ARCHETYPE, "needs doctrine #91", "—", ["ecommerce/page-examples/category-pages"], []),
    E("Product page archetype", ARCHETYPE, "needs doctrine #91", "—", ["ecommerce/page-examples/product-pages"], []),
    E("Cart page archetype", ARCHETYPE, "needs doctrine #91", "—", ["ecommerce/page-examples/shopping-cart-pages"], []),
    E("Checkout page archetype", ARCHETYPE, "needs doctrine #91", "—", ["ecommerce/page-examples/checkout-pages"], []),
    E("Order detail page archetype", ARCHETYPE, "needs doctrine #91", "—",
      ["ecommerce/page-examples/order-detail-pages"], []),
    E("Order history page archetype", ARCHETYPE, "needs doctrine #91", "—",
