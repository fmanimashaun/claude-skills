...
|---|---|---|---|
| `rails-stack` | 1.61.0 | — | Rails 8.1 + Hotwire development doctrine: vanilla-first stack, pure RSpec testing, Turbo |
| `rails-flow` | 1.44.0 | 20 | Agentic development flow for Rails 8 projects |
