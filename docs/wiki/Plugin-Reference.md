...
|---|---|---|---|
| `rails-stack` | 1.62.0 | — | Rails 8.1 + Hotwire development doctrine: vanilla-first stack, pure RSpec testing, Turbo |
...
| `design-flow` | 1.42.0 | 12 | Agentic UI/design flow for Rails 8 + Hotwire + Tailwind v4 |
