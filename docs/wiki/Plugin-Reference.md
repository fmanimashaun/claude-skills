...
|---|---|---|---|
| `rails-stack` | 1.68.1 | — | Rails 8.1 + Hotwire development doctrine: vanilla-first stack, pure RSpec testing, Turbo |
| `rails-flow` | 1.52.0 | 20 | Agentic development flow for Rails 8 projects |
