...
GUARD = Guard(
    ...
    subject="scripts/variant_conformance.py",
    selftest="scripts/variant_conformance.py",
    ...
    needs=("scripts/llm_tell_detector.py",
           "scripts/doctrine_path.py",
           "scripts/rendered_conformance.py",
           "scripts/conformance_collector.js"),
    mutations=(
        Mutation(
